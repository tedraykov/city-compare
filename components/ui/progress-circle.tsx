// Databyte Progress Circle [v0.0.1]
...
const progressCircleVariants = tv({
  ...
  variants: {
    variant: {
      default: {
        background: 'stroke-brand-200 dark:stroke-blue-500/30',
        circle: 'stroke-brand-500 dark:stroke-blue-500',
      },
      neutral: {
...
const ProgressCircle = React.forwardRef<SVGSVGElement, ProgressCircleProps>(
  (
    ...
    return (
      <>
        <div className={cx('relative w-fit')} tremor-id="tremor-raw">
          <svg
            ref={forwardedRef}
            width={radius * 2}
            height={radius * 2}
