...
const selectTriggerStyles = [
  cx(
    ...
    // placeholder
    'data-[placeholder]:text-zinc-400 data-[placeholder]:dark:text-zinc-500',
    // background color
    ...
    'data-[disabled]:dark:border-zinc-700 data-[disabled]:dark:bg-zinc-800 data-[disabled]:dark:text-zinc-500',
    focusInput
    // invalid (optional)
      ...
      <SelectPrimitives.Icon asChild>
        <RiExpandUpDownLine
          className={cx(
            ...
            // disabled
            'group-data-[disabled]/trigger:text-zinc-300 group-data-[disabled]/trigger:dark:text-zinc-600'
          )}
        />
    ...
    <SelectPrimitives.Portal>
      <SelectPrimitives.Content
        ...
        className={cx(
          ...
          'data-[side=bottom]:animate-slideDownAndFade data-[side=right]:animate-slideRightAndFade data-[side=top]:animate-slideUpAndFade data-[side=left]:animate-slideLeftAndFade',
          className
        )}
